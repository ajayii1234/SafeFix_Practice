...
if(isset($_SESSION["sum_form_error"])){
 ...
 ?>
            <div class="mb-3 row">
                                  ...
                                  <div class="mb-3 row">
                                      <label for="conpwd" class="col-4"><br>Confirm Password</label>
                                      <div class="col-8">
                                  ...
                                  <div class="mb-3 row">
                                      <label for="cover" class="col-4"><br>Upload Picture</label>
                                      <div class="col-8">
                                    ...
                                    <div class="mb-3 row">
                                      <label for="phone" class="col-4"><br>Phone Number</label>
                                      <div class="col-8">
                                  ...
                                  <div class="row">
                                          ...
                                          <div class="col-md-8 mb-3">
                                          <input class="form-check-input" type="radio" name="role" value="customer">&nbsp<label>Customer</label>&nbsp&nbsp
                                          <input class="form-check-input" type="radio" name="role" value="repairer">&nbsp<label>Repairer</label>
                                          </div>
                                      </div>
                                    ...
                                    <div class="row mb-3">
                                        <label for="addr" class="col-4"><br>Home Address</label>
                                        <div class="col-8">
                                  ...
                                  <div class="mb-3 row">
                                      <label for="password" class="col-4"><br>State</label>
                                      <div class="col-8">
                                  ...
                                  <div class="mb-3 row">
                                      ...
                                      <input type="checkbox" name="checkbox" id="checkbox">&nbsp<label>I have read through the terms and conditions and agree to it</label>
                                      </div>
                                  </div>
