...
?>
    ...
    <div class="row">
    <div class="col-md-12">
        <h1 class="text-center">All Repairers</h1>
                ...
                foreach($allrepairers as $repair){
                    ...
                    echo "</tr>"; -->
                        ...
                        <tr>
                            ...
                            <td><a href='customerrequest.php?id=<?php echo $repair["cust_id"]?>' target="_blank" class="btn btn-outline-primary">Send Request</a></td>
                            <td><a href='customerchatmessage.php?id=<?php echo $repair["cust_id"]?>' target="_blank" class="btn btn-outline-primary">Message Repairer</a></td>
                           
                            <td><a href='feedbackform.php?id=<?php echo $repair["cust_id"]?>' target="_blank" class="btn btn-outline-primary">Rate Service</a></td>
                            <td><a href='payment.php?id=<?php echo $repair["cust_id"]?>' target="_blank" class="btn btn-outline-primary">Make Payment</a></td>
                        </tr>
